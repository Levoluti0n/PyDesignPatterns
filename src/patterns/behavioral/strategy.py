...
class CreditCardPayment(PaymentStrategy):
    ...
    def pay(self, amount: float):
        print(f"Processing credit card payment of ${amount:.2f} for card holder '{self.card_holder_name}' using card number '{self.card_number[-4:]}'...")
...
class PayPalPayment(PaymentStrategy):
    ...
    def pay(self, amount: float):
        print(f"Processing PayPal payment of ${amount:.2f} for user '{self.email}'...")
...
class CryptoPayment(PaymentStrategy):
    ...
    def pay(self, amount: float):
        print(f"Processing cryptocurrency payment of ${amount:.2f} to wallet '{self.wallet_address[:6]}...'...")
